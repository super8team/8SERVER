                ...
                <div class="dropdown">
                    <div id="dropdownDiv_blockLib">
                      ...
                      <!-- 패키지 리스트 출력 코드 -->
                        ...
                        <button style="margin-bottom:35px;margin-left:15px;height:50px" class="content_list" type="button" name="button" value="{{$packages[0]['contents'][$i]['xml']}}" >		                        <button style="margin-bottom:35px;margin-left:15px;height:50px" class="content_list" type="button" name="button" value="{{$packages[0]['contents'][$i]['xml']}}" >
