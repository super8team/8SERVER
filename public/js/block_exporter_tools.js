...
BlockExporterTools.prototype.getRootBlockFromXml_ = function(xml) {
  ...
  blockInfor = "/"+rootBlock;
  // alert(blockInfor);
  // ab = blockInfor;
  // document.getElementById("example").innerHTML = ab;
  // ab = ab + blockInfor+"<br>";
  // console.log("^^"+rootBlock);
  // console.log(blockInfor);
  // if(count == 0)
  // {
  //   document.getElementById("example").innerHTML = blockInfor;
  //   count++;
  // }
  // else if(count == 1)
  // {
  //   document.getElementById("example1").innerHTML = blockInfor;
  //   count++;
  // }
  // else if(count == 2)
  // {
  //   document.getElementById("example2").innerHTML = blockInfor;
  //   count++;
  // }
...
BlockExporterTools.prototype.createBlockSelectorFromLib =
  ...
  // console.log(blockSelector);       여태까지 저장한 블럭 들
  var example = document.getElementById('example');
  // example.html(blockSelector);
  // Clear the block selector.

  // var a = blockSelector['id'][0];
  // var b = blockSelector['id'][1];
  // .getElementsByTagName("div");
  // document.getElementById("example").innerHTML = a + b;
  // document.getElementById("example").innerHTML = blockSelector['id'][0];
  // document.getElementById("example").innerHTML = blockSelector['id'][1];

  // example.innerHTML(blockSelector['id']);
  var child;
