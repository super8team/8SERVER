...
class DetailPlansSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('detail_plans')->insert([
          ...
          'start_time' => Carbon::create(2016, 4, 26, 14, 00, 00, 'Asia/Seoul'),
          'end_time' => Carbon::create(2016, 4, 26, 15, 00, 00, 'Asia/Seoul')],

          ['place' => 7, 'plan' => $plans[1]->no,
          'start_time' => Carbon::create(2016, 4, 26, 15, 00, 00, 'Asia/Seoul'),
          'end_time' => Carbon::create(2016, 4, 26, 16, 00, 00, 'Asia/Seoul')],

          ['place' => 8, 'plan' => $plans[1]->no,
          'start_time' => Carbon::create(2016, 4, 26, 16, 00, 00, 'Asia/Seoul'),
          'end_time' => Carbon::create(2016, 4, 26, 17, 00, 00, 'Asia/Seoul')],

          ['place' => 4, 'plan' => $plans[1]->no,
          'start_time' => Carbon::create(2016, 4, 26, 17, 00, 00, 'Asia/Seoul'),
          'end_time' => Carbon::create(2016, 4, 26, 18, 00, 00, 'Asia/Seoul')],

          ['place' => 26, 'plan' => $plans[1]->no,
          'start_time' => Carbon::create(2016, 4, 26, 18, 00, 00, 'Asia/Seoul'),
          'end_time' => Carbon::create(2016, 4, 26, 19, 00, 00, 'Asia/Seoul')],
          ...
          'start_time' => Carbon::create(2015, 9, 10, 11, 00, 00, 'Asia/Seoul'),
          'end_time' => Carbon::create(2015, 9, 10, 13, 00, 00, 'Asia/Seoul')],

          ['place' => 18, 'plan' => $plans[0]->no,
          'start_time' => Carbon::create(2015, 9, 10, 13, 00, 00, 'Asia/Seoul'),
          'end_time' => Carbon::create(2015, 9, 10, 15, 00, 00, 'Asia/Seoul')],

          ['place' => 14, 'plan' => $plans[0]->no,
          'start_time' => Carbon::create(2015, 9, 10, 15, 00, 00, 'Asia/Seoul'),
          'end_time' => Carbon::create(2015, 9, 10, 16, 00, 00, 'Asia/Seoul')],
        ]);
