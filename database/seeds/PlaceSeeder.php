...
class PlaceSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('places')->insert([
            ...
            //['name'=>'분황사', 'explain' => "분황사는, 경상북도 경주시 구황동에 있는 사찰이다. 선덕여왕 3년에 낙성된 이래 불교가 융성했던 신라의 전성기와 함께했던, 1,400년 동안 법등을 밝혀 온 유서 깊은 사찰이다. 송고승전에는 왕분사로 오기되어 있다", 'lat'=>35.840386, 'lng'=>129.233627, 'radius'=>10, 'img'=>'noIMG'],
            //['name'=>'황룡사지', 'explain' => "황룡사는 경상북도 경주시에 있었던 사찰로서, 경주에서 가장 컸던 사찰로 알려져 있으나, 현재는 터만 남아 있다. 황룡사는 9층 목탑과 장륙상과 더불어 신라 삼보의 하나로 유명하였다. 신라의 사찰로 553년 기공이 시작 되어 569년에 완공되었다고 여겨지나, 566년 일단 준공되었다가 645년에 완성되었다는 설도 있다. 고려 고종 25년 에 몽골의 침입으로 소실되었다. 현재 그 터인 황룡사지 가 사적 제6호로 지정되어 있다.", 'lat'=>35.837895, 'lng'=>129.232171, 'radius'=>10, 'img'=>'noIMG'],
            //['name'=>'신라 역사 과학관', 'explain' => "", 'lat'=>35.806884, 'lng'=>129.311351, 'radius'=>10, 'img'=>'noIMG'],
            ['name'=>'福岡市民防災センター', 'explain' => "", 'lat'=>33.589436, 'lng'=>130.354964, 'radius'=>10, 'img'=>'noIMG'],
